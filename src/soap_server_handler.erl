...
check_soap_conformance(Soap_req) ->
    ...
    try Handler:check_soap_conformance(Soap_req, Handler_state) of
        ...
        Class:Reason:ST ->
            throw(callback_error(Class, Reason, ST, Soap_req, Handler_state))
    end.
...
try_header_fun(Fun, Soap_req, Handler_s) ->
    try
        ...
        Class:Reason:ST ->
            throw(callback_error(Class, Reason, ST, Soap_req, Handler_s))
    end.

callback_error(Class, Reason, ST, Soap_req, Handler_s) ->
